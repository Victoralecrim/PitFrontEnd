...
export const Navbar = () => {
  return (
    <nav className="flex items-center justify-between flex-wrap bg-[#1A2238] py-4 lg:px-12 shadow border-solid border-b-2 border-zinc-500">
        ...
        <div className="flex items-center flex-shrink-0 text-green-500 mr-16">
          <Link to="/">
            <span className="font-semibold text-2xl tracking-tight">
              Fit<span className="text-orange-500">Food</span>
            </span>
          </Link>
        </div>
      ...
      <div className="menu w-full flex-grow lg:flex lg:items-center lg:w-auto lg:px-3 px-8">
        ...
        <div className="flex ">
          <a
            href="#"
            className="block text-md px-4 py-2 rounded text-orange-500 ml-2 font-bold border-solid border-2 border-orange-500 hover:text-white mt-4 hover:bg-orange-700 lg:mt-0"
          >
            Cadastrar
          </a>
          ...
          <a
            href="#"
            className=" block text-md px-4  ml-2 py-2 rounded text-orange-500 font-bold border-solid border-2 border-orange-500 hover:text-white mt-4 hover:bg-orange-700 lg:mt-0"
          >
            Fazer LogIn
          </a>
        </div>
